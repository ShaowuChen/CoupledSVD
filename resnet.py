...
Describe:
    ...
    Train: 
        ...
        2、with a pretrain ckpt: do as 1, and then use tf.Saver api to reload the ckpt;
        3、with a dic: pass the parameter 'weight_dict=the_parameter_ditionary'; For example, download the Pytorch .pth and transpose it to be .npy which can be read as a dict, then build the network in tf with this dict.  

Platform: Ubuntu; Tensorflow1.15

Acc：
    Transfer from pytorch:
                            raw                  fine_tuned
                        top1     top5           top1    top5
            resnt18:   
            resnet34:  66.51%   87.27%          
            resnet50:  68.95%   88.64%          
            resnet101: 
            resnet152: 
